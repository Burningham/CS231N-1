...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        #calculate output dimension of max pool
        mp_d = (input_dim[1]//2)*(input_dim[2]//2)*num_filters
        
        #hidden affine layer
        self.params['W2'] = np.random.normal(0.0,weight_scale,(mp_d,hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        mp_d = (X.shape[2]//2)*(X.shape[3]//2)*W1.shape[0]

        #pass scores through three layers and save in separate caches
        scores,cache_1 = conv_relu_pool_forward(X,W1,b1,conv_param,pool_param)
        scores = scores.reshape((X.shape[0],mp_d))
        ...
        #layer 3 gradients
        dx,grads['W3'],grads['b3'] = affine_backward(dclass,cache_3)
        #layer 2 gradients
        dx,grads['W2'],grads['b2'] = affine_relu_backward(dx,cache_2)
        
        #reshape dx
        dx = dx.reshape((X.shape[0],W1.shape[0],X.shape[2]//2,X.shape[3]//2))
        #layer 1 gradients
